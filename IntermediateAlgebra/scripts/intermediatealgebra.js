/*
    ...
    https://precalculus.appspot.com/IntermediateAlgebra/Algebra.html
    https://precalculus.appspot.com/IntermediateAlgebra/GradeCalculator.html
*/
...
function gradeMLM(event) {
    ...
    var weightTopicOne = parseFloat(document.getElementById("weightTopicOne").value, 10) || 0,
        ...
        weightTopicThirteen =+ parseFloat(document.getElementById("weightTopicThirteen").value, 10) || 0,
        scoreTopicThirteen =+ parseFloat(document.getElementById("scoreTopicThirteen").value, 10) || 0,
        weightedScoreTopicThirteen,

        weightTopicFourteen =+ parseFloat(document.getElementById("weightTopicFourteen").value, 10) || 0,
        ...
        weightTopicSeventeen =+ parseFloat(document.getElementById("weightTopicSeventeen").value, 10) || 0,
        scoreTopicSeventeen =+ parseFloat(document.getElementById("scoreTopicSeventeen").value, 10) || 0,
        weightedScoreTopicSeventeen,

        weightTopicEighteen =+ parseFloat(document.getElementById("weightTopicEighteen").value, 10) || 0,
        scoreTopicEighteen =+ parseFloat(document.getElementById("scoreTopicEighteen").value, 10) || 0,
        weightedScoreTopicEighteen,

        weightTopicNineteen =+ parseFloat(document.getElementById("weightTopicNineteen").value, 10) || 0,
        ...
        weightTopicTwentyOne =+ parseFloat(document.getElementById("weightTopicTwentyOne").value, 10) || 0,
        scoreTopicTwentyOne =+ parseFloat(document.getElementById("scoreTopicTwentyOne").value, 10) || 0,
        weightedScoreTopicTwentyOne,

        weightTopicTwentyTwo =+ parseFloat(document.getElementById("weightTopicTwentyTwo").value, 10) || 0,
        scoreTopicTwentyTwo =+ parseFloat(document.getElementById("scoreTopicTwentyTwo").value, 10) || 0,
        weightedScoreTopicTwentyTwo,

        weightTopicTwentyThree =+ parseFloat(document.getElementById("weightTopicTwentyThree").value, 10) || 0,
        scoreTopicTwentyThree =+ parseFloat(document.getElementById("scoreTopicTwentyThree").value, 10) || 0,
        ...
        weightTopicTwentyFour =+ parseFloat(document.getElementById("weightTopicTwentyFour").value, 10) || 0,
        scoreTopicTwentyFour =+ parseFloat(document.getElementById("scoreTopicTwentyFour").value, 10) || 0,
        weightedScoreTopicTwentyFour,

        weightTopicTwentyFive =+ parseFloat(document.getElementById("weightTopicTwentyFive").value, 10) || 0,
        scoreTopicTwentyFive =+ parseFloat(document.getElementById("scoreTopicTwentyFive").value, 10) || 0,
        weightedScoreTopicTwentyFive,

        weightTopicTwentySix =+ parseFloat(document.getElementById("weightTopicTwentySix").value, 10) || 0,
        scoreTopicTwentySix =+ parseFloat(document.getElementById("scoreTopicTwentySix").value, 10) || 0,
        weightedScoreTopicTwentySix,

        weightTopicTwentySeven =+ parseFloat(document.getElementById("weightTopicTwentySeven").value, 10) || 0,
        scoreTopicTwentySeven =+ parseFloat(document.getElementById("scoreTopicTwentySeven").value, 10) || 0,
        weightedScoreTopicTwentySeven,

        weightTopicTwentyEight =+ parseFloat(document.getElementById("weightTopicTwentyEight").value, 10) || 0,
        scoreTopicTwentyEight =+ parseFloat(document.getElementById("scoreTopicTwentyEight").value, 10) || 0,
        weightedScoreTopicTwentyEight,

        weightTopicTwentyNine =+ parseFloat(document.getElementById("weightTopicTwentyNine").value, 10) || 0,
        scoreTopicTwentyNine =+ parseFloat(document.getElementById("scoreTopicTwentyNine").value, 10) || 0,
        ...
        weightTopicThirtyOne =+ parseFloat(document.getElementById("weightTopicThirtyOne").value, 10) || 0,
        scoreTopicThirtyOne =+ parseFloat(document.getElementById("scoreTopicThirtyOne").value, 10) || 0,
