...
function gradeMLM(event) {
    ...
    var weightTwoOne1st = parseFloat(document.getElementById("weightTwoOne1st").value, 10) || 0,
        ...
        sumWeightsMLM = 
        weightTwoOne1st + weightTwoOne2nd + weightTwoOne3rd + weightTwoOne4th + weightTwoOne5th + weightTwoOne6th
        + weightTwoTwo1st + weightTwoTwo2nd
        + weightTwoThree1st + weightTwoThree2nd + weightTwoThree3rd
        + weightTwoFour1st + weightTwoFour2nd + weightTwoFour3rd
        + weightTwoFive1st + weightTwoFive2nd + weightTwoFive3rd + weightTwoFive4th
        + weightTwoSix 
        + weightThreeOne1st + weightThreeOne2nd 
        + weightThreeTwo
        + weightThreeThree1st + weightThreeThree2nd + weightThreeThree3rd + weightThreeThree4th + weightThreeThree5th
        + weightThreeFour 
        + weightThreeFive 
        + weightFourOne1st + weightFourOne2nd + weightFourOne3rd + weightFourOne4th
        ...
        + weightFourFive1st + weightFourFive2nd + weightFourFive3rd
        + weightFourSix1st + weightFourSix2nd + weightFourSix3rd + weightFourSix4th
        + weightFourSeven1st + weightFourSeven2nd
        ...
        + weightFiveSix1st + weightFiveSix2nd + weightFiveSix3rd + weightFiveSix4th
        ...
        sumWeightedScoresMLM = 
        weightedScoreTwoOne1st + weightedScoreTwoOne2nd + weightedScoreTwoOne3rd + weightedScoreTwoOne4th + weightedScoreTwoOne5th + weightedScoreTwoOne6th
        + weightedScoreTwoTwo1st + weightedScoreTwoTwo2nd 
        + weightedScoreTwoThree1st + weightedScoreTwoThree2nd + weightedScoreTwoThree3rd
        + weightedScoreTwoFour1st + weightedScoreTwoFour2nd + weightedScoreTwoFour3rd
        + weightedScoreTwoFive1st + weightedScoreTwoFive2nd + weightedScoreTwoFive3rd + weightedScoreTwoFive4th
        + weightedScoreTwoSix 
        + weightedScoreThreeOne1st + weightedScoreThreeOne2nd 
        + weightedScoreThreeTwo
        + weightedScoreThreeThree1st + weightedScoreThreeThree2nd + weightedScoreThreeThree3rd + weightedScoreThreeThree4th + weightedScoreThreeThree5th
        + weightedScoreThreeFour 
        + weightedScoreThreeFive 
        + weightedScoreFourOne1st + weightedScoreFourOne2nd + weightedScoreFourOne3rd + weightedScoreFourOne4th
        ...
        + weightedScoreFourFive1st + weightedScoreFourFive2nd + weightedScoreFourFive3rd
        + weightedScoreFourSix1st + weightedScoreFourSix2nd + weightedScoreFourSix3rd + weightedScoreFourSix4th
        + weightedScoreFourSeven1st + weightedScoreFourSeven2nd
        ...
        + weightedScoreFiveSix1st + weightedScoreFiveSix2nd + weightedScoreFiveSix3rd + weightedScoreFiveSix4th
